CREATE DATABASE  IF NOT EXISTS `rizz_eatery` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `rizz_eatery`;
-- MySQL dump 10.13  Distrib 8.0.31, for Win64 (x86_64)
--
-- Host: localhost    Database: rizz_eatery
-- ------------------------------------------------------
...
INSERT INTO `food_items` VALUES (1,'Allo Paratha',6.00),(2,'Qeema Paratha',7.00),(3,'Pizza',8.00),(4,'Lassi',5.00),(5,'Anda Burger',6.00),(6,'Biryani',9.00),(7,'Sandwich',4.00),(8,'Pakora',7.00),(9,'Samosa',5.00);
